...
class MyCustomDialog2(val mcontext: DailyInputDetailFragment, val medlist:ArrayList<String>, val medlistid: ArrayList<Int>,
var pos:Int,val qnt:Int,var medid: Int) : DialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        edt_name.setText(medlist[pos])
        edt_Quantity.setText(qnt.toString())
        ...
        btn_delete.setOnClickListener {
            dismiss()
            closeKeyboard()
            mcontext.meddeleteCallback(pos) }
        btn_update.setOnClickListener {
            dismiss()
            closeKeyboard()
            mcontext.medupdateCallback(medid, pos, edt_Quantity.text.toString()) }
