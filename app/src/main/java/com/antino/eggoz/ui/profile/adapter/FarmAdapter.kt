...
class FarmAdapter(private val contextmain: MainActivity,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val add="${farmdata[position].billingAddress.buildingAddress} ${farmdata[position].billingAddress.landmark} ${farmdata[position].billingAddress.billingCity} ${farmdata[position].billingAddress.streetAddress} ${farmdata[position].billingAddress.pinCode}"
